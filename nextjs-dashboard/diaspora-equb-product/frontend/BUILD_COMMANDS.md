...
**Correct:** `--dart-define=PRIVY_APP_ID=your_privy_app_id`
...
Include your Privy app credentials (`PRIVY_APP_ID` and `PRIVY_APP_CLIENT_ID`) for wallet auth.
...
1. In the **frontend** Vercel project, set Environment Variables: **API_BASE_URL** = `https://equb-db.vercel.app/api`, **PRIVY_APP_ID**, **PRIVY_APP_CLIENT_ID**, **CHAIN_ID**, **RPC_URL**.
